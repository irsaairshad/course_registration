...
const AssignmentSchema = new mongoose.Schema({
  ...
  status:        { type: String, enum: ['Requested', 'Assigned', 'Completed'], default: 'Assigned' }
}, { timestamps: true });
...
// Make `reviewer_id` optional so authors can "request" a reviewer (reviewer assigned later by admin)
AssignmentSchema.path('reviewer_id').required(false);
